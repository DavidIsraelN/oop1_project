...
/*
* some custom colors for the program
*/

const sf::Color Gray(153, 153, 153);
const sf::Color DeepRed(51, 0, 34);
const sf::Color SemiDeepRed(DeepRed - sf::Color(0, 0, 0, 100));
...
const sf::Color SemiTransparent(255, 255, 255, 140);
const sf::Color Opacity(255, 255, 255, 255);
